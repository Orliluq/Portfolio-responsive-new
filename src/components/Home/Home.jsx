    ...
    <div>
      ...
      <section className="home-section">
        <div className="web-box">
          <img className="giffy" src="../images/avatar1.jpeg" alt="" />
          <h3 className="hi">{isEnglish ? "HI, I'M" : "HOLA, SOY"}</h3>
          <h1 className="h1-intro"> ORLI DUN </h1>
          <h3 className="secondary-text">{isEnglish ? "AND I'M" : "Y SOY"}</h3>
          <h2 className="web-text">
            {" "}
            <span className="front-span">{isEnglish ? "FULL STACK" : "DESARROLLADORA"}</span> <br />{" "}
            <span className="dev-span">{isEnglish ? "DEVELOPER" : "FULL STACK"}</span>
          </h2>
